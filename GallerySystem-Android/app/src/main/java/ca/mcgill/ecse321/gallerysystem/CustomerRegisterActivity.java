...
public class CustomerRegisterActivity extends AppCompatActivity {
    ...
    public void register(View v){
        ...
        TextView addressInput = (TextView) findViewById(R.id.address);
        ...
        HttpUtils.post("/customer/" + username.replaceAll("\\s", "_")+"?email="+email+ "&address=" + address.replaceAll("\\s", "_") + "&password="+ inputPassword, new RequestParams(), new JsonHttpResponseHandler(){
