...
public class GallerySystemRestController {
	...
	public ArtPieceDto createArtPieceDto(@PathVariable("name") String name, @RequestParam Integer quantity, @RequestParam float price, @RequestParam Integer discountPercentage, @RequestParam Float commissionPercentage, @RequestParam String description, @RequestParam Integer artID, @RequestParam String artistEmail) throws IllegalArgumentException {
		ArtPiece artpiece = service.createArtPiece(name, quantity, price, discountPercentage, commissionPercentage, description, artID, artistEmail);
	...
	private ArtPieceDto convertToDto(ArtPiece a) {
		...
		ArtPieceDto artPieceDto = new ArtPieceDto(a.getArtName(), a.getQuantity(), a.getPrice(), a.getDiscountPercentage(), a.getCommissionPercentage(), a.getDescription(), a.getArtID(), a.getArtist());
		return artPieceDto;
	}
	...
	public CustomerDto createCustomer(@PathVariable("name") String userName, @RequestParam String address, @RequestParam String email, @RequestParam String password) throws
	...
	public CustomerDto updateCustomer(@PathVariable("email") String email, @RequestBody Customer customerDetails) throws ResourceNotFoundException {
	...
	public ArtistDto createArtist(@PathVariable("name") String userName, @RequestParam String email, @RequestParam String password) throws
	IllegalArgumentException {
	...
	public AdministratorDto createAdministrator(@PathVariable("name") String userName, @RequestParam String email, @RequestParam String password) throws
	IllegalArgumentException {
	...
	@PostMapping(value = {"/shoppingCart/{name}>","/shoppingCart/{name}/"})
	public ShoppingCartDto createShoppingCart(@RequestParam("name") Integer itemNumber, @PathVariable String cartID, Boolean isEmpty, Customer customer) throws IllegalArgumentException {
		ShoppingCart sc = service.createShoppingCart(itemNumber, itemNumber, isEmpty, customer);
	...
	private ShoppingCartDto convertToDto(ShoppingCart sc) {
		...
		ShoppingCartDto scDto = new ShoppingCartDto(sc.getItemNumber(), sc.getCartID(), sc.isIsEmpty(), sc.getCustomer(), sc.getSelectedItem());
	...
	public OrderDto createOrder(Integer ordernumber, Date orderDate, ShoppingCart shoppingCart,@RequestParam("customer") Customer customer) throws IllegalArgumentException {
	...
	@PostMapping(value = {"/SelectedItem/{name}>","/SelectedItem/{name}/"})
	public SelectedItemDto createSelectedItem(Integer itemID, Integer quantity, ArtPiece artpiece) throws IllegalArgumentException {
		SelectedItem si = service.createSelectedItem(itemID, quantity, artpiece);
